            ...
            <div class="row">
              <div class="input-field col s6">
                <input id="{{$mv}}mv_d20-d10" name="{{$mv}}mv_d20-d10" 
                  type="number" class="validate experimental_data_color" placeholder="Insira dado...">
                <label for="{{$mv}}mv_d20-d10">D<sub>20</sub>/D<sub>10</sub></label>
              </div>
              <div class="input-field col s6">
                <input id="{{$mv}}mv_tpr_20-10" type="number" class="input_data_color" disabled>
                <label for="{{$mv}}mv_tpr_20-10">TPR<sub>20/10</sub></label>
              </div>
            </div>
            <div class="row">
              <div class="input-field col s4">
                <input id="{{$mv}}mv_input-1" name="{{$mv}}mv_input-1" type="number" 
                  class="validate table_data_color" placeholder="Insira dado...">
              </div>
              <div class="input-field col s4">
                <input id="{{$mv}}mv_output-1" type="number" class="input_data_color" disabled>
              </div>
              <div class="input-field col s4">
                <input id="{{$mv}}mv_input-2" name="{{$mv}}mv_input-2" type="number" 
                  class="validate table_data_color" placeholder="Insira dado...">
              </div>
            </div>
            <div class="row">
              <div class="input-field col s4">
                <input id="{{$mv}}mv_input-3" name="{{$mv}}mv_input-3" type="number" 
                  class="validate table_data_color" placeholder="Insira dado...">
              </div>
              <div class="input-field col s4">
              ...
              <div class="input-field col s4">
                <input id="{{$mv}}mv_input-4" name="{{$mv}}mv_input-4" type="number" 
                  class="validate table_data_color" placeholder="Insira dado...">
              </div>
            </div>
            <div class="row">
